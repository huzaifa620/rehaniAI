...
def main():
    ...
    df1, df2, df3, df4, df5, df6, df7, df8, df9, df10, df11, df12, df13, df14, df15, df16, df17, df18, df19, df20 = None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None
    ...
    # df19 = booking_filter()
    df20 = global_remax_filter()

    df_concat = pd.concat([df1, df2, df3, df4, df5, df6, df7, df8, df9, df10, df11, df12, df13, df14, df15, df16, df17, df18, df19, df20], ignore_index=True)
...
if __name__ == "__main__":
    ...
    print('')
    df_concat = add_more_calculations(df_concat)
    print('')
